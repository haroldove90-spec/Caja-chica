...
import { X, FileText, ExternalLink, ZoomIn, ZoomOut, RotateCw, RefreshCw } from 'lucide-react';
...
export const EvidenceModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-2xl max-w-4xl w-full p-4 sm:p-5 space-y-3 shadow-2xl relative max-h-[92vh] flex flex-col">
        {/* Modal Header */}
          ...
          <div className="flex items-center justify-between bg-zinc-100 px-3 py-1.5 rounded-xl text-xs shrink-0">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <button
                ...
                className="p-1.5 rounded-lg bg-white border border-zinc-200 hover:bg-zinc-200 text-zinc-700 transition-colors"
              >
        ...
        <div className="flex-1 overflow-auto rounded-xl bg-zinc-950/90 p-4 border border-zinc-200 flex items-center justify-center min-h-[320px] max-h-[65vh] relative">
          {previewEvidencia.type === 'pdf' ? (
            <div className="text-center p-8 space-y-3 bg-white rounded-xl">
              <FileText className="w-12 h-12 text-[#024182] mx-auto" />
            ...
            <div className="transition-transform duration-200 ease-out flex items-center justify-center w-full h-full overflow-auto">
              <img
                ...
                className="max-h-[55vh] max-w-full object-contain shadow-2xl transition-all"
              />
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-between shrink-0 pt-2 border-t border-zinc-100 text-xs">
          <span className="text-[11px] text-zinc-500">
            Haga scroll o use los botones de la barra para ampliar el ticket
          </span>
          <button
            onClick={handleClose}
